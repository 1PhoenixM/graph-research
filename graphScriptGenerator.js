...
if(process.argv.length < 5){
	console.log("Usage: node graphScriptGenerator input-file <sql | gstar> output-file");
	process.exit(1);
}
...
//If SQL...
if(process.argv[3] === "SQL" || process.argv[3] === "sql"){
